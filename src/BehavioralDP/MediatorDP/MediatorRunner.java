...
public class MediatorRunner {
    ...
    static void mediatorDemo(){
        ...
        actor1.sendMessage("Topic2","Message for Topic-2"); // actor2 karsilayacak
        actor1.sendMessage("Topic3","Message for Topic-3"); // actor3 karsilayacak
        actor1.sendMessage("Topic4","Message for Topic-4"); // actor4 karsilayacak

        actor2.sendMessage("Topic1","Message for Topic-1"); // actor1 karsilayacak
